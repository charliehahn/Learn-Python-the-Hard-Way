i = 0
numbers = []
# Creates an emply list (similar to an array in other languages)
...
while i < 6:
    ...
    # loop returns to "while i < 6," which stop the loop.
...
# 3 Add another variable to the funciton arguments that you can pass in
...
def drill_5(n, s):
    ...
    # Need to specifiy starting point of 0 so Python
    # reads the other elements correctly
    # 0 = starting point/lower limit. 14 = upper limit. 4 = steps
    for i in numbers5:
        print "Item: %d" % i
    print numbers5
