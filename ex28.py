...
# True and True
# For "and" both need to be true, so True

print "2:", False and True, "(False?)"
# False and True
# False and (irrelevant but True)
# If any statement in an "and" is false, then False
# and no need to go any further
...
# not (True and False) # Zed may be cool but the text isn't identical
# not (False)
# True
...
# False and (irrelevant but no(False or True))
# False and not(True)
# False and False
# False
